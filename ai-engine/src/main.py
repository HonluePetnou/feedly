...
SLEEP_TIME = 10  # secondes entre chaque cycle
...
def process_reviews():
    ...
    try:
        ...
        print(f"❌ Erreur pendant le traitement des avis : {e}")
        db.rollback()
        return False
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if not worked:
            time.sleep(SLEEP_TIME)  # Pause si rien à faire ou en cas d'erreur
